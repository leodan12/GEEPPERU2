...
<div  >
    <div class="row">
        ...
        <div class="d-flex justify-content-end mb-5" data-kt-docs-table-toolbar="base">
            <a href="{{url('principal/create')}}" class="btn btn-primary">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="mimodalLabel">Ver Imagen </h1>
...
<script>
    ...
    mimodal.addEventListener('show.bs.modal', event => {
        ...
        var urlprincipal = "{{ url('principal/show') }}";
        $.get(urlprincipal + '/' + id, function(data) {
            //console.log(data);
    ...
    var principales = @json($principales);
    var urlprincipales = "{{ url('principal') }}";


    var table = defineTable($('#listado'), [], [0, 1, 2  ], 'principales', function() {}, false, false, false);
    ...
    listarOnTable(table, principales, 0, [], viewbtn, editbtn, deletetn, urlprincipales, false, []);
