...
<div class="row">
    <div class="col col-12">
        <h5>Listado de Descripciones</h5>
...
<div class="">
    <div class="row">
        <div class="d-flex justify-content-end mb-5" data-kt-docs-table-toolbar="base">
            <a href="{{url('descripcion/create')}}" class="btn btn-primary">
...
<script>
    ...
    var descripciones = @json($descripciones);
    var urldescripciones = "{{ url('descripcion') }}";


    var table = defineTable($('#listado'), [], [0, 1 ], 'descripciones', function() {}, true, true, false);
    ...
    listarOnTable(table, descripciones, 0, [], false, true, true, urldescripciones, false, []);
</script>
