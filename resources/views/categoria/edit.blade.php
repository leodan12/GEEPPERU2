                ...
                <Form method="POST" action="{{ url('categoria/update',$categoria->id) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-12 mb-5">
                            ...
                            <input type="text" placeholder=" ingrese categoria" name="categoria" id="categoria" class="form-control" required value="{{$categoria->nombre}}">
                        </div>


                        <hr>

                        <h5>Agregar Sub categorias</h5>
...
<br><br>
                        ...
                        @php $ind=0 ; @endphp
                        @php $indice=count($subcategorias) ; @endphp
                            ...
                            <table class="table table-row-bordered gy-5 gs-5" id="detalle">
                                ...
                                <tbody>
                                    ...
                                    <tr id="fila{{$ind}}">
                                        ...
                                        <td><button type="button" class="btn btn-link btn-color-danger btn-sm delete" onclick="eliminarFila(  '{{$item->idsubcategoria}}','{{$ind}}'  )" data-id="0"><i class="bi bi-trash-fill"></i></button></td>
    ...
    function eliminarFila(idBD, ind) {
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.get('/deletedetallecategoria/' + idBD, function(data) {
                    if (data[0]) {
                        $('#fila' + ind).remove();
                        toDelete = true;
                        icon = "success";
