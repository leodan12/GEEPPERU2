...
class ProductoController extends Controller
{
   ...
   public function show($id){
    $producto=DB::table('productos as p') 
        ->select(  'p.id','p.name','p.price','p.stock','p.marca','p.descripcion',
        'p.oferta','p.porcentajedescuento','p.image_path')
        ->where('p.id','=',$id)->get()  ;
    ...
    $especificaciones=DB::table('productos as p')
        ...
        return ['producto'=>$producto,'subcategorias'=>$subcategorias
    ...
    public function edit($id)
    {
        ...
        return view('producto/edit',['producto'=>$producto,'subcategorias'=>$subcategorias
    ,'especificaciones'=>$especificaciones,'DetalleSubCategorias'=>$DetalleSubCategorias ,
